    ...
    <div class="container">
        <div class="content">
            <div class="card">
                ...
                <h2>Bus Maintenance Application</h2>                    
                <form method="POST" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <select id="issue_type" name="issue_type" required>
                            ...
                            <option value="oil">Oil Leak</option>
                            ...
                            <option value="transmission">Transmission Problem</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" placeholder="Please provide detailed information about the issue, including symptoms, when it started, and any relevant observations..." required></textarea>
                    </div>
                ...
                if (isset($_POST['submitBtn'])){
                    include('conn.php');
                    $sql = "INSERT INTO maintenance_apply (`apply_date`, `driver_id`, `maintenance_type`, `description`, `status`) VALUES (
                    ...
                    if(!mysqli_query($con,$sql)){
                        ...
                        echo "<script>alert('Submitted successfully');window.location.href='BMS_driver_maintenance.php';</script>";
                    }
            ...
            <div class="status-box">
                <h2>My Maintenance Applications</h2>
                ...
                $result = mysqli_query($con,
                    "SELECT apply_date, maintenance_type, description, status
                    FROM maintenance_apply
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                ...
                                <td>".ucfirst($row['maintenance_type'])."</td>
                    ...
                    echo "<p>No maintenance applications submitted yet.</p>";
                }
